```cpp
Object drawRecPrOut(const double x, const double y, const double z,
...
---
## Basic Info
Draws the outline of a rectangular prism in absolute space
### Return Type
...
| `l`       | `double`                                    | Length of prism        | ❌        |
| `w`       | `double`                                    | Width of prism         | ❌        |
| `h`       | `double`                                    | Height of prism        | ❌        |
| `rgba`    | [`Color`](../structures_and_types/color.md) | Color of prism         | ❌        |
| `roll`    | `double`                                    | Roll of circle         | ✅        |
| `pitch`   | `double`                                    | Pitch of prism         | ✅        |
| `yaw`     | `double`                                    | Yaw of prism           | ✅        |
---
## Example
...
// Calling the drawRecPrOut() function
objectList.insert({"recOut", openrender::drawRecPrOut(200.0, 200.0, 200.0, 200.0, 200.0, 200.0, {255, 255, 255, 255})});
