...
std::vector<point> drawLine(const double x0, const double y0, const double z0, const double x1, const double y1, const double z1, const color rgba) {
...
std::vector<point> drawNAALine(const double x0, const double y0, const double z0, const double x1, const double y1, const double z1, const color rgba) {
    double dx = std::abs(x1 - x0);
    double dy = std::abs(y1 - y0);
    double dz = std::abs(z1 - z0);
...
std::vector<point> drawTriangle(const double x0, const double y0, const double z0, const double x1, const double y1, const double z1, const double x2, const double y2, const double z2, const color rgba) {
    ...
    pointData[2] = drawNAALine(x0, y0, z0, x2, y2, z2, rgba);
...
std::vector<point> drawCircle(const double x, const double y, const double z, const double r, const color rgba, double roll = 0.0, double pitch = 0.0, double yaw = 0.0) {
    ...
    for (int i = 0; i < (fPoints.size()/8)-1; i++) {
        drawLine(fPoints[(i*8)].x, fPoints[(i*8)].y, fPoints[(i*8)].z, fPoints[((i+1)*8)].x+1, fPoints[((i+1)*8)].y+1, fPoints[((i+1)*8)].z+1, rgba);
        drawLine(fPoints[(i*8)+1].x, fPoints[(i*8)+1].y, fPoints[(i*8)+1].z, fPoints[((i+1)*8)+1].x+1, fPoints[((i+1)*8)+1].y+1, fPoints[((i+1)*8)+1].z+1, rgba);
        drawLine(fPoints[(i*8)+2].x, fPoints[(i*8)+2].y, fPoints[(i*8)+2].z, fPoints[((i+1)*8)+2].x+1, fPoints[((i+1)*8)+2].y+1, fPoints[((i+1)*8)+2].z+1, rgba);
        drawLine(fPoints[(i*8)+3].x, fPoints[(i*8)+3].y, fPoints[(i*8)+3].z, fPoints[((i+1)*8)+3].x+1, fPoints[((i+1)*8)+3].y+1, fPoints[((i+1)*8)+3].z+1, rgba);
        drawLine(fPoints[(i*8)+4].x, fPoints[(i*8)+4].y, fPoints[(i*8)+4].z, fPoints[((i+1)*8)+4].x+1, fPoints[((i+1)*8)+4].y+1, fPoints[((i+1)*8)+4].z+1, rgba);
        drawLine(fPoints[(i*8)+5].x, fPoints[(i*8)+5].y, fPoints[(i*8)+5].z, fPoints[((i+1)*8)+5].x+1, fPoints[((i+1)*8)+5].y+1, fPoints[((i+1)*8)+5].z+1, rgba);
        drawLine(fPoints[(i*8)+6].x, fPoints[(i*8)+6].y, fPoints[(i*8)+6].z, fPoints[((i+1)*8)+6].x+1, fPoints[((i+1)*8)+6].y+1, fPoints[((i+1)*8)+6].z+1, rgba);
        drawLine(fPoints[(i*8)+7].x, fPoints[(i*8)+7].y, fPoints[(i*8)+7].z, fPoints[((i+1)*8)+7].x+1, fPoints[((i+1)*8)+7].y+1, fPoints[((i+1)*8)+7].z+1, rgba);
    }
...
std::vector<point> drawNAACircle(const double x, const double y, const double z, const double r, const color rgba, double roll = 0.0, double pitch = 0.0, double yaw = 0.0) {
    std::vector<point> points;
    ...
    for (int i = 0; i < (fPoints.size()/8)-1; i++) {
        drawNAALine(fPoints[(i*8)].x, fPoints[(i*8)].y, fPoints[(i*8)].z, fPoints[((i+1)*8)].x+1, fPoints[((i+1)*8)].y+1, fPoints[((i+1)*8)].z+1, rgba);
        drawNAALine(fPoints[(i*8)+1].x, fPoints[(i*8)+1].y, fPoints[(i*8)+1].z, fPoints[((i+1)*8)+1].x+1, fPoints[((i+1)*8)+1].y+1, fPoints[((i+1)*8)+1].z+1, rgba);
        drawNAALine(fPoints[(i*8)+2].x, fPoints[(i*8)+2].y, fPoints[(i*8)+2].z, fPoints[((i+1)*8)+2].x+1, fPoints[((i+1)*8)+2].y+1, fPoints[((i+1)*8)+2].z+1, rgba);
        drawNAALine(fPoints[(i*8)+3].x, fPoints[(i*8)+3].y, fPoints[(i*8)+3].z, fPoints[((i+1)*8)+3].x+1, fPoints[((i+1)*8)+3].y+1, fPoints[((i+1)*8)+3].z+1, rgba);
        drawNAALine(fPoints[(i*8)+4].x, fPoints[(i*8)+4].y, fPoints[(i*8)+4].z, fPoints[((i+1)*8)+4].x+1, fPoints[((i+1)*8)+4].y+1, fPoints[((i+1)*8)+4].z+1, rgba);
        drawNAALine(fPoints[(i*8)+5].x, fPoints[(i*8)+5].y, fPoints[(i*8)+5].z, fPoints[((i+1)*8)+5].x+1, fPoints[((i+1)*8)+5].y+1, fPoints[((i+1)*8)+5].z+1, rgba);
        drawNAALine(fPoints[(i*8)+6].x, fPoints[(i*8)+6].y, fPoints[(i*8)+6].z, fPoints[((i+1)*8)+6].x+1, fPoints[((i+1)*8)+6].y+1, fPoints[((i+1)*8)+6].z+1, rgba);
        drawNAALine(fPoints[(i*8)+7].x, fPoints[(i*8)+7].y, fPoints[(i*8)+7].z, fPoints[((i+1)*8)+7].x+1, fPoints[((i+1)*8)+7].y+1, fPoints[((i+1)*8)+7].z+1, rgba);
    }
