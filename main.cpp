...
int main() {
    drawRecPrOut(400.0, 200.0, 400.0, 100.0, 100.0, 100.0, 30.0, 40.0, 60.0, {255, 255, 255, 255});
    drawRecPrOut(600.0, 400.0, 400.0, 300.0, 200.0, 200.0, 70.0, 190.0, 10.0, {244, 67, 41, 69});
